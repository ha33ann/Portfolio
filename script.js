...
let click = document.querySelector('.click');
            ...
            click.addEventListener("click",()=>{
                ...
                if(list.classList.contains('newlist')){
                    ...
                    Skills.style.transform = "translateY(150px)";
                    const list1 = document.getElementById("list1");
                    list1.style.transform = "translateY(150px)";
                    const list2 = document.getElementById("list2");
                    list2.style.transform = "translateY(150px)";
                    const list3 = document.getElementById("list3");
                    list3.style.transform = "translateY(150px)";
                    const list4 = document.getElementById("list4");
                    list4.style.transform = "translateY(150px)";
                    const list5 = document.getElementById("list5");
                    list5.style.transform = "translateY(150px)";
                    const list6 = document.getElementById("list6");
                    list6.style.transform = "translateY(150px)";
                    const list7 = document.getElementById("list7");
                    list7.style.transform = "translateY(150px)";
                    const list8 = document.getElementById("list8");
                    list8.style.transform = "translateY(150px)";
                    const list9 = document.getElementById("list9");
                    list9.style.transform = "translateY(150px)";
                    const list10 = document.getElementById("list10");
                    list10.style.transform = "translateY(150px)";
                    const list11 = document.getElementById("list11");
                    list11.style.transform = "translateY(150px)";
                    const list12 = document.getElementById("list12");
                    list12.style.transform = "translateY(150px)";
            ...
            function copy() {
              ...
              function resume(){
                window.open("https://pdfhost.io/v/FwuMgsbKh_Europass");
              }
